...
<script setup>
    ...
    document.title = "KuKaKo-OSC Schema"

    onMounted(()=> {
        console.log('Schema main')
    })
            ...
            <div class="col-12 m-0 p-0">
                <div class="h-100 d-flex flex-column w-100 m-0 p-0">
                    ...
                    <div class="row m-0 p-0  flex-grow-1 ">
                        <GraphDisplay mode="schema"/>
                        <NodeCreator mode="schema"/>
                    </div>
                </div>
            </div>
        </div>
...
header a {
  ...
  margin-left: 1em;
  font-family: 'Aleo','Lato','Helvetica Neue',Arial,sans-serif;
